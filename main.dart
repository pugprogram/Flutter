...
class _MyHomePageState extends State<MyHomePage> {
  void _getBitovkaLampRequestONaa() {
    setState(() {
      http.get(Uri.parse('http://iocontrol.ru/board/FirstTry1/aa/1')).then((response) {
  ...
  void _getBitovkaLampRequestOFFaa() {
    setState(() {
      http.get(Uri.parse('http://iocontrol.ru/board/FirstTry1/aa/0')).then((response) {
        print("Response status: ${response.statusCode}");
        print("Response body: ${response.body}");
      }).catchError((error){
        print("Error: $error");
  ...
  void _getBitovkaLampRequestONbb() {
    setState(() {
      http.get(Uri.parse('http://iocontrol.ru/board/FirstTry1/bb/1')).then((response) {
        print("Response status: ${response.statusCode}");
        print("Response body: ${response.body}");
      }).catchError((error){
        print("Error: $error");
  ...
  void _getBitovkaLampRequestOFFbb() {
    setState(() {
      http.get(Uri.parse('http://iocontrol.ru/board/FirstTry1/bb/0')).then((response) {
        print("Response status: ${response.statusCode}");
        print("Response body: ${response.body}");
      }).catchError((error){
        print("Error: $error");
